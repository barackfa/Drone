...
//float q->SEq_1 = 1.0f, q->SEq_2 = 0.0f, q->SEq_3 = 0.0f, q->SEq_4 = 0.0f; // estimated orientation quaternion elements with initial conditions
...
f_1 = twoSEq_2 * q->SEq_4 - twoSEq_1 * q->SEq_3 - a_x;
f_2 = twoSEq_1 * q->SEq_2 + twoSEq_3 * q->SEq_4 - a_y;
f_3 = 1.0f - twoSEq_2 * q->SEq_2 - twoSEq_3 * q->SEq_3 - a_z;
J_11or24 = twoSEq_3; // J_11 negated in matrix multiplication
J_12or23 = 2.0f * q->SEq_4;
