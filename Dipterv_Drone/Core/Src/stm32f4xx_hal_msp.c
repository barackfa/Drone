...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(CRNT_GPIO_Port, CRNT_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(MAGN_SCL_GPIO_Port, MAGN_SCL_Pin);

    HAL_GPIO_DeInit(MAGN_SDA_GPIO_Port, MAGN_SDA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(PRESS_SCL_GPIO_Port, PRESS_SCL_Pin);

    HAL_GPIO_DeInit(PRESS_SDA_GPIO_Port, PRESS_SDA_Pin);
